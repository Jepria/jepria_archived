...
public abstract class JepRiaApplicationAutoImpl implements JepRiaApplicationAuto {
  private static Logger logger = Logger.getLogger(JepRiaApplicationAutoImpl.class.getName());
  
  private boolean isStarted = false;
    
  public JepRiaApplicationAutoImpl(String baseUrl,
        String browserName,
