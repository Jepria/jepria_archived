 ...
 * <ol>
 *   <li/>На уровне <a href="https://tomcat.apache.org/tomcat-7.0-doc/config/context.html#Environment_Entries">контекстных переменных Томката</a>
 *   <br/>
 *   Переменные определяются в серверном конфигурационном файле Tomcat/conf/context.xml элементами {@code <Environment/>} следующим образом:
 *   <pre>
 *   &lt;Context&gt;
