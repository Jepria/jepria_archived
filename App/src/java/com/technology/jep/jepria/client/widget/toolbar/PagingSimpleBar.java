 ...
 * </dl>
 */
public class PagingSimpleBar extends SimplePanel implements PagingToolBar {

	
	String DEFAULT_HEIGHT = "22px";
	
	private static final String PAGING_BAR_STYLE = "jepRia-PagingSimpleBar";
	private static final String PAGING_BAR_NUMBER_STYLE = "jepRia-PagingSimpleBar-pageNumber";
	...
	private void addItems() {
		first = makeButton(JepTexts.button_beginning_alt(), new ClickHandler() {
			@Override
		...
		prev = makeButton(JepTexts.button_previous_alt(), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				previous();
			}
		...
		next = makeButton(JepTexts.button_next_alt(), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				next();
			}
		...
		last = makeButton(JepTexts.button_ending_alt(), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				last();
			}
		...
		refresh = makeButton(JepTexts.button_refresh_alt(), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				refresh();
			}
	...
	public Button makeButton(String name, ClickHandler handler) {
		return makeButton(name, handler, true);
	}

	public Button makeButton(String name, ClickHandler handler, Boolean enabled) {
